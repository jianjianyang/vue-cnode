  ...
  <div class="signup">
    <div class="signup-left">
      <div class="panel">
        ...
        <div class="inner">
          <form id="signin_form" class="form-horizontal" action="/auth/github/create" method="post">
            <input type="hidden" name="_csrf" value="BJzEVCmu-UCh9AXvfyFS4f7F0YB68PwjorJY">
