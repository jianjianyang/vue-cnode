<template>
  <div class="collections">
    ...
    <div class="panel">
      ...
      <div class="panel">
        <div class="header">
          <span class="col_fade">{{list.loginname}}收藏的话题</span>
        </div>
        <div class="inner">
      ...
      <sidebar>
        <div slot="slide-header">
          ...
          <div class="inner">
            <div class="user_card">
              <div>
                <a class="user_avatar" :href="'/user/'+id">
                  <img :src="lists.avatar_url">
                </a>
                <span class="user_name"><a class="dark" :href="'/user/'+id">{{id}}</a></span>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      console.log(this.id)
      this.axios.get(global.globalData.api + '/topic_collect/' + this.id, {
        params: {}
      }).then((res) => {
        console.log(res)
      ...
      this.axios.get(global.globalData.api+'/user/' + this.id, {
        params: {}
      }).then((res) => {
